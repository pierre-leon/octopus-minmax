## v1.0.10-PL - v1.0.10-PL comparison-only current tariff
Test build: chart from plot_comparison plus comparison-only support for unrecognised/fixed current tariffs.

Does not switch away from locked or unknown products. Image: `pierreleon/octopus-minmax-bot:v1.0.10-PL`
