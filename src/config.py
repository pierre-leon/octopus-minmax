...
# The website session that authorises switches is pasted in by hand and lasts 7 days.
# Warn once it has this many days left, checked at the end of each nightly run.
